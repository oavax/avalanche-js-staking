...
var StakingTransaction = /*#__PURE__*/function (_TransactionBase) {
  ...
  function StakingTransaction(directive, stakeMsg, nonce, gasPrice, gasLimit, chainID, messenger, txStatus) {
    ...
    if (messenger === void 0) {
      messenger = avalancheJsTransaction.defaultMessenger;
    }

    if (txStatus === void 0) {
      txStatus = avalancheJsTransaction.TxStatus.INTIALIZED;
    }
  ...
  _proto.encode = function encode() {
    ...
    if (!this.directive) {
      ...
      raw.push(avalancheJsCrypto.hexlify(this.directive));
    }
    ...
    if (!this.nonce) {
      ...
      raw.push(avalancheJsCrypto.hexlify(this.nonce));
    }

    raw.push(avalancheJsCrypto.hexlify(this.gasPrice));
    raw.push(avalancheJsCrypto.hexlify(this.gasLimit));

    if (this.chainId != null && this.chainId !== 0) {
      raw.push(avalancheJsCrypto.hexlify(this.chainId));
      raw.push('0x');
      raw.push('0x');
    }
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              _context.next = 6;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.SendRawStakingTransaction, this.rawTransaction, this.messenger.chainType, this.messenger.currentShard);
            ...
            case 6:
              ...
              this.setTxStatus(avalancheJsTransaction.TxStatus.PENDING);
            ...
            case 14:
              ...
              this.setTxStatus(avalancheJsTransaction.TxStatus.REJECTED);
...
}(avalancheJsTransaction.TransactionBase);
/** @hidden */
...
var Decimal = /*#__PURE__*/function () {
  function Decimal(value) {
    ...
    var val = new avalancheJsUtils.Unit(combinedStr).asWei().toWei();

    if (val.gt(new avalancheJsUtils.Unit(StakingSettings.MAX_DECIMAL.toString()).asWei().toWei())) {
  ...
  _proto3.encode = function encode() {
    var raw = [];
    raw.push(avalancheJsUtils.numberToHex(this.value));
    return raw;
  };
...
var CreateValidator = /*#__PURE__*/function () {
  ...
  _proto5.encode = function encode() {
    var raw = [];
    raw.push(avalancheJsCrypto.hexlify(avalancheJsTransaction.TransactionBase.normalizeAddress(this.validatorAddress)));
    raw.push(this.description.encode());
    raw.push(this.commissionRates.encode());
    raw.push(avalancheJsCrypto.hexlify(this.minSelfDelegation));
    raw.push(avalancheJsCrypto.hexlify(this.maxTotalDelegation));
    raw.push(this.encodeArr());
    raw.push(avalancheJsCrypto.hexlify(this.amount));
    return raw;
  };
...
var Delegate = /*#__PURE__*/function () {
  ...
  _proto7.encode = function encode() {
    var raw = [];
    raw.push(avalancheJsCrypto.hexlify(avalancheJsTransaction.TransactionBase.normalizeAddress(this.delegatorAddress)));
    raw.push(avalancheJsCrypto.hexlify(avalancheJsTransaction.TransactionBase.normalizeAddress(this.validatorAddress)));
    raw.push(avalancheJsCrypto.hexlify(this.amount));
    return raw;
  };
...
var StakingFactory = /*#__PURE__*/function () {
  function StakingFactory(messenger) {
    ...
    this.nonce = 0;
    this.gasPrice = new avalancheJsUtils.Unit('100').asGwei().toHex();
    this.gasLimit = new avalancheJsUtils.Unit('210000').asWei().toHex();
    this.chainId = 1;
    this.signature = {
      v: 0,
      r: '',
  ...
  _proto.createValidator = function createValidator(_ref) {
    ...
    this.directive = exports.Directive.DirectiveCreateValidator;
    return this;
  };
  ...
  _proto.editValidator = function editValidator(_ref2) {
    ...
    this.directive = exports.Directive.DirectiveEditValidator;
    return this;
  };
  ...
  _proto.delegate = function delegate(_ref3) {
    ...
    this.directive = exports.Directive.DirectiveDelegate;
    return this;
  };
  ...
  _proto.undelegate = function undelegate(_ref4) {
    ...
    this.directive = exports.Directive.DirectiveUndelegate;
    return this;
  };
  ...
  _proto.collectRewards = function collectRewards(_ref5) {
    ...
    this.directive = exports.Directive.DirectiveCollectRewards;
    return this;
  };
  ...
  _proto.build = function build() {
    ...
    return new StakingTransaction(this.directive, this.stakeMsg, this.nonce !== undefined ? this.nonce : 0, this.gasPrice !== undefined ? this.gasPrice : new avalancheJsUtils.Unit('100').asGwei().toHex(), this.gasLimit !== undefined ? this.gasLimit : new avalancheJsUtils.Unit('210000').asWei().toHex(), this.chainId !== undefined ? this.chainId : 1, this.messenger, avalancheJsTransaction.TxStatus.INTIALIZED);
  };
...
//# sourceMappingURL=avalanche-js-staking.cjs.development.js.map
